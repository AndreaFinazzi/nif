...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--bag-directory",
        type=str,
        default="/home/usrg-racing/media/Samsung_T5/OCt(10)_bag",
    )
    ...
    filename = os.path.join(output_path, bag_directory + ".csv")

    VEH4_dir_list = [
        f
        for f in os.listdir(bag_directory)
        if isdir(join(bag_directory, f)) and "VEH8" in f
    ]
    ...
    for VEH4_dir in VEH4_dir_list:
        ...
        sensors_dir_list = [
            f
            for f in os.listdir(VEH4_dir_path)
        ...
        for sensor_dir in sensors_dir_list:
            ...
            tmp_db3_file_list_sensor = [
                f
                for f in os.listdir(sensor_dir_path)
        ...
        for autonomy_dir in autonomy_dir_list:
            ...
            tmp_db3_file_list_autonomy = [
                f
                for f in os.listdir(autonomy_dir_path)
        ...
        for db3_file in db3_file_list_autonomy:  # each db3
            ...
            if "/raptor_dbw_interface/wheel_speed_report" in parser.topic_msg_message:
                speed_msgs = parser.get_messages(
            ...
            if len(drive_time) != 0:
                ...
                average_speed = [
                    (x + y) / 2 for x, y in zip(rear_left, rear_right)
                ]  # rad/sec

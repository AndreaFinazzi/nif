...
class CarnivalInterface : public rclcpp::Node
{
  public:
    ...
    // carnival control command publisher (IAC stack -> carnival)
        ...
        m_control_cmd_pub = this->create_publisher<ackermann_msgs::msg::AckermannDriveStamped>("control_cmd", 10);
    ...
    // carnival control command subscriber (IAC stack -> carnival)
        m_steering_cmd_sub = this-> create_subscription<nif::common::msgs::ControlCmd>(
            "/control_pool/control_cmd", rclcpp::QoS{10},
            [this](nif::common::msgs::ControlCmd::SharedPtr msg) {steering_cmd_callback(msg);});
  ...
  private:
    ...
    rclcpp::Subscription<nif::common::msgs::ControlCmd>::SharedPtr m_steering_cmd_sub;
    ...
    ackermann_msgs::msg::AckermannDriveStamped m_control_cmd_msg;
    ...
    void steering_cmd_callback(const nif::common::msgs::ControlCmd::SharedPtr msg){
        // std::cout<<msg->steering_control_cmd.data<<std::endl;
        m_control_cmd_msg.drive.steering_angle = -1*msg->steering_control_cmd.data; 
    }

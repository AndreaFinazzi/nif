...
class FakeSystemStatus : public rclcpp::Node
{
  public:
    ...
    // timer
        ...
        m_fake_mission_status.mission_status_code = nif_msgs::msg::MissionStatus::MISSION_SLOW_DRIVE;
        m_fake_mission_status.max_velocity_mps = 10.0; //kph, not mps

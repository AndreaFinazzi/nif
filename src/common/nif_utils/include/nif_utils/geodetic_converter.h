...
#ifndef NIF_UTILS_GEODETICCONVERTER_HPP
#define NIF_UTILS_GEODETICCONVERTER_HPP
...
public:
  GeodeticConverter(double home_latitude = 0,
                    double home_longitude = 0,
                    double home_altitude = 0)
...
#endif // NIF_UTILS_GEODETICCONVERTER_HPP

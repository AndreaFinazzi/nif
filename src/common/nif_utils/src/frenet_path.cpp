#include "nif_utils/frenet_path.h"
...
FrenetPath::FrenetPath(FrenetPath& frenet_path)
  : points_d_(frenet_path.points_d()),
    ...
    time_(frenet_path.time()),
    points_x_(frenet_path.points_x()),
    points_y_(frenet_path.points_y()),
    yaw_(frenet_path.yaw()),
    curvature_(frenet_path.curvature()),
    delta_velocity_(frenet_path.delta_velocity()),
    cost_d_(frenet_path.cost_d()),
    cost_s_(frenet_path.cost_s()),
    cost_total_(frenet_path.cost_total()),
    blocking_flg_(frenet_path.blocking_flg()),
    blocking_idx_(frenet_path.blocking_idx()) {}

void FrenetPath::pushBackDerivatives_d(double zeroth_derivative,
...
void FrenetPath::pushBackDerivatives_s(double zeroth_derivative,
                                       double first_derivative,
                                       double second_derivative,
                                       double third_derivative) {

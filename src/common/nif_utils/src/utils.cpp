...
nif::common::utils::coordination::getPtBodytoGlobal(
  ...
  point_in_global_stamped =
      getPtBodytoGlobal(current_odom_, point_in_body_.pose);
...
nif::common::utils::coordination::getPtBodytoGlobal(
  ...
  point_in_global_stamped.pose =
      getPtBodytoGlobal(current_odom_.pose.pose, point_in_body_);
  point_in_global_stamped.header.frame_id = current_odom_.header.frame_id;

  return point_in_global_stamped;
}

geometry_msgs::msg::Pose nif::common::utils::coordination::getPtBodytoGlobal(
    const geometry_msgs::msg::Pose &current_pose_,
    const geometry_msgs::msg::Pose &point_in_body_) {
  tf2::Vector3 tf_body_in_global_origin(current_pose_.position.x,
                                        current_pose_.position.y,
                                        current_pose_.position.z);
  tf2::Quaternion tf_body_in_global_quat(
      current_pose_.orientation.x, current_pose_.orientation.y,
      current_pose_.orientation.z, current_pose_.orientation.w);
  tf2::Transform tf_body_in_global(tf_body_in_global_quat,
                                   tf_body_in_global_origin);

  tf2::Vector3 tf_point_in_body_origin(point_in_body_.position.x,
                                       point_in_body_.position.y,
                                       point_in_body_.position.z);
  tf2::Quaternion tf_point_in_body_quat(
      point_in_body_.orientation.x, point_in_body_.orientation.y,
      point_in_body_.orientation.z, point_in_body_.orientation.w);
  tf2::Transform tf_point_in_body(tf_point_in_body_quat,
...
nif::common::utils::coordination::getPtGlobaltoBody(
  ...
  point_in_body_stamped =
      getPtGlobaltoBody(current_odom_, point_in_global_.pose);
...
nif::common::utils::coordination::getPtGlobaltoBody(
  ...
  point_in_body_stamped.pose =
      getPtGlobaltoBody(current_odom_.pose.pose, point_in_global_);
...
nif::common::utils::coordination::getPtGlobaltoBody(
  ...
  point_in_body_stamped.pose =
      getPtGlobaltoBody(current_odom_.pose.pose, pose_in_global);

  return point_in_body_stamped;
}

geometry_msgs::msg::Pose nif::common::utils::coordination::getPtGlobaltoBody(
    const geometry_msgs::msg::Pose &current_pose_,
    const geometry_msgs::msg::Pose &point_in_global_) {
  tf2::Vector3 tf_body_in_global_origin(current_pose_.position.x,
                                        current_pose_.position.y,
  ...
  tf2::Vector3 tf_point_in_global_origin(point_in_global_.position.x,
                                         point_in_global_.position.y,
                                         point_in_global_.position.z);
  tf2::Quaternion tf_point_in_global_quat(
      point_in_global_.orientation.x, point_in_global_.orientation.y,
      point_in_global_.orientation.z, point_in_global_.orientation.w);
  tf2::Transform tf_point_in_global(tf_point_in_global_quat,
                                    tf_point_in_global_origin);

  tf2::Transform tf_point_in_body =
      tf_body_in_global.inverse() * tf_point_in_global;
...
nav_msgs::msg::Path nif::common::utils::coordination::getPathGlobaltoBody(
  ...
  for (int i = 0; i < path_in_global_.poses.size(); i++) {
    geometry_msgs::msg::PoseStamped point_in_body =
        getPtGlobaltoBody(current_pose_, path_in_global_.poses[i]);

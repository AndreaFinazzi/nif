...
#ifndef ROS2MASTER_CONTROL_LQR_CAMBER_COMPENSATED_NODE_H
#define ROS2MASTER_CONTROL_LQR_CAMBER_COMPENSATED_NODE_H
...
namespace nif
{
  namespace control
  {
    ...
    class ControlLQRCamberCompNode : public nif::control::IControllerNode
    {
    public:
      explicit ControlLQRCamberCompNode(const std::string &node_name);
    ...
    private:
      ...
      //! Misc. Parameters (see notes in constructor)run
...
#endif // ROS2MASTER_CONTROL_LQR_CAMBER_COMPENSATED_NODE_H

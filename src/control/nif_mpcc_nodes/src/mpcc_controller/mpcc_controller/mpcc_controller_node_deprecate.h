...
namespace mpcc
{
    ...
    public:
        ...
        void toGlobalPath(geometry_msgs::Point local_position, geometry_msgs::Point &global_position);
        void filterBoundary(const nav_msgs::PathConstPtr &raw_path, nav_msgs::Path &filtered_path);
        ...
        nav_msgs::Path mpc_bound_in_;
        nav_msgs::Path mpc_bound_out_;
    ...
    private:
        ...
        ros::Publisher mpc_bound_in_pub_;
        ros::Publisher mpc_bound_out_pub_;

...
#ifndef LUM_NET_COMMAND_ADDR_OPS_NET_DSC_H
#define LUM_NET_COMMAND_ADDR_OPS_NET_DSC_H
 ...
 *        offset macro.
 */
#define _LUM_NET_CMD_VERIFY_ADDR_INDEX_NET_DSC_OPS_ALLOWED(addr, ...) (false)
...
#endif // LUM_NET_COMMAND_ADDR_OPS_NET_DSC_H

...
#ifndef ROS2_LUMINAR__STRING_UTILS_HPP_
#define ROS2_LUMINAR__STRING_UTILS_HPP_
...
{
  return ros2_luminar::ltrim(ros2_luminar::rtrim(str, white), white);
}
...
#endif  // ROS2_LUMINAR__STRING_UTILS_HPP_

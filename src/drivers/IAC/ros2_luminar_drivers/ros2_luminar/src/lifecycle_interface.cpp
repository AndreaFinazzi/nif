...
{
  RCLCPP_INFO(this->get_logger(), "Configuring Luminar driver node.");
  onConfigure();
...
{
  RCLCPP_INFO(this->get_logger(), "Activating Luminar driver node.");
  onActivate();
  is_active = true;
  return CallbackReturn::SUCCESS;
}
...
{
  RCLCPP_INFO(this->get_logger(), "Deactivating Luminar driver node.");
  onDeactivate();
  is_active = false;
  return CallbackReturn::SUCCESS;
}
...
{
  RCLCPP_ERROR(this->get_logger(), "Handing error in Luminar driver node.");
  onError();
  return CallbackReturn::SUCCESS;
}
...
{
  RCLCPP_INFO(this->get_logger(), "Shutting down Luminar driver node.");
  onShutdown();
  return CallbackReturn::SUCCESS;
}
...
{
  RCLCPP_INFO(this->get_logger(), "Cleaning up Luminar driver node.");
  onCleanup();
  return CallbackReturn::SUCCESS;
}

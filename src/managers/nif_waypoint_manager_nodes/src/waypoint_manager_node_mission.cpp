    ...
    : IBaseNode(node_name_, common::NodeType::PLANNING)
{
  ...
  m_occu_map_subscriber =
      this->create_subscription<nav_msgs::msg::OccupancyGrid>(
          "/semantics/costmap_generator/occupancy_grid", nif::common::constants::QOS_PLANNING,
...
void nif::managers::WaypointManagerMissionNode::graphCallback(const nav_msgs::msg::Path::SharedPtr graph_path_msg)
{

...
if __name__ == "__main__":
    ...
    pit_wpt = os.path.join(dir,'maps',TRACK_NAME,'pit_lane.csv',)
    raceline = os.path.join(dir,'maps',TRACK_NAME,'race_line.csv',)
    ...
    mission_yaml_file = os.path.join(dir_two_up,'system','nif_mission_manager_nodes','config', 'transitions.ims.yaml')

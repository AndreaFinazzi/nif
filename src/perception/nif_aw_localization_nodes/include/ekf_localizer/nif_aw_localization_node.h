...
private:
  ...
  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr
      sub_odom_measure_; // !< @brief measurement odom subscriber including pose
  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr
      sub_odom_system_; // !< @brief measurement odom subscriber including twist
  ...
  std::shared_ptr<nav_msgs::msg::Odometry> measure_odom_ptr_;   // !< @brief current measured pose
  std::shared_ptr<nav_msgs::msg::Odometry> system_odom_ptr_;   // !< @brief current measured pose
   ...
   */
  void callbackOdometryMeasure(const nav_msgs::msg::Odometry::SharedPtr msg);
  void callbackOdometrySystem(const nav_msgs::msg::Odometry::SharedPtr msg);
   ...
   */
  void measurementUpdatePose(const nav_msgs::msg::Odometry::SharedPtr msg);
   ...
   */
  void
  measurementUpdateTwist(const nav_msgs::msg::Odometry::SharedPtr msg);

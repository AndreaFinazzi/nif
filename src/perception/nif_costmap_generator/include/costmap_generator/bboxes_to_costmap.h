...
public:
  ...
  grid_map::Matrix makeCostmapFromBBoxes(const grid_map::GridMap& costmap,
                                          ...
                                          const jsk_recognition_msgs::BoundingBoxArray::ConstPtr& in_bboxes);
...
private:
  ...
  Eigen::MatrixXd makeRectanglePoints(const jsk_recognition_msgs::BoundingBox& in_object,
  ...
  grid_map::Polygon makePolygonFromBBox(const jsk_recognition_msgs::BoundingBox& in_object,
                                        const double expand_rectangle_size);

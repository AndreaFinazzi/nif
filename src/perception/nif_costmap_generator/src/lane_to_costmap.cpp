...
// Constructor
LaneToCostmap::LaneToCostmap() {}

LaneToCostmap::~LaneToCostmap() {}

void LaneToCostmap::initGridmapParam(const grid_map::GridMap &gridmap) {
...
bool LaneToCostmap::isValidInd(const grid_map::Index &grid_ind) {
  bool is_valid = false;
...
grid_map::Index
LaneToCostmap::fetchGridIndexFromPoint(const pcl::PointXYZ &point) {
...
LaneToCostmap::assignPoints2GridCell( const grid_map::GridMap &gridmap, const pcl::PointCloud<pcl::PointXYZ>::Ptr &in_sensor_points) 
{
...
grid_map::Matrix LaneToCostmap::calculateCostmap(
...
grid_map::Matrix LaneToCostmap::makeCostmapFromSensorPoints(
    const double maximum_height_thres, const double minimum_lidar_height_thres,
    const double grid_min_value, const double grid_max_value,
    const grid_map::GridMap &gridmap, const std::string &gridmap_layer_name,

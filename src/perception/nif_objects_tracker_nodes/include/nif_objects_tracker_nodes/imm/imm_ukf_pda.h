...
private:
    ...
    //                      nif_msgs::msg::DetectedObject &out_object, UKF &target);
    ...
    bool arePointsClose(const geometry_msgs::msg::Point &in_point_a,
                        const geometry_msgs::msg::Point &in_point_b, float in_radius);
...
public:
    ...
    nif_msgs::msg::DetectedObjectArray getTrackedResult(nif_msgs::msg::DetectedObjectArray &input);
};

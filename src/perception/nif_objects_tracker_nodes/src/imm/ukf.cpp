...
#include "nif_objects_tracker_nodes/imm/ukf.h"
/**
...
double UKF::calculateNIS(const nif_msgs::msg::DetectedObject &in_object,
...
bool UKF::isLaneDirectionAvailable(
    const nif_msgs::msg::DetectedObject &in_object, const int motion_ind,

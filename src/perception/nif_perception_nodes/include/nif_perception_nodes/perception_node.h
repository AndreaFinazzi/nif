...
private:
  ...
  message_filters::TimeSynchronizer<
      ...
      sensor_msgs::msg::Image, sensor_msgs::msg::Image, sensor_msgs::msg::Image,
      sensor_msgs::msg::PointCloud2, delphi_esr_msgs::msg::EsrTrack>
      sensors_message_filter;
  //             sensors_message_filter(camera_NODENAME_sub x 6, lidar_mesh_sub,
  //             radar_mesh_sub, 3);
  //             sync_.registerCallback(std::bind(&sensorMessageFilterCallback,
  //             this, std::placeholders::_1, std::placeholders::_2));

  //          TODO : Define a better way to do this. Hardcoding the camera subs
  //          significantly reduces reusability.
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr
      camera_front_left_sub;
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr
      camera_front_left_center_sub;
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr
      camera_front_right_center_sub;
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr
      camera_front_right_sub;
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr
      camera_rear_right_sub;

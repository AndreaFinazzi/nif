 ...
 *
 * @note Logic copied from
 *https://github.com/ethz-asl/geodetic_utils/blob/master/geodetic_utils/include/geodetic_utils/geodetic_conv.hpp
 *  this gets slightly different results than pymap3d
 *(https://github.com/geospace-code/pymap3d/tree/bd91a5ff4e9066eb33fead3006ba9de191e2c5e5/src/pymap3d)
 *  primarily in the z calculation - it might be worth comparing implementations
 *(or swapping to python if that's desirable for whatever reason)
 *
 * @note this doesn't belong here.. should be a bvs_localization package for
 *this to live in
 **/

...
def main(argv):
    ...
    def train_step(
        ...
        z = model._params(
            visual_features=batch["lidar_features"],
    ...
    def write(
        ...
        num_samps = 3
        z = model._params(visual_features=batch["lidar_features"],player_past=batch["player_past"])[:8]
        ...
        lidar = None
        # Logs on `TensorBoard`.
        ovhf = batch["lidar_features"].detach()[:8]

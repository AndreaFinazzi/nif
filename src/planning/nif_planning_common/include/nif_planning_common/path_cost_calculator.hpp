#ifndef NIFPLANNINGCOMMON_PATH_COST_CALCULATOR_H
#define NIFPLANNINGCOMMON_PATH_COST_CALCULATOR_H
...
#define WEIGHT_ORIGIN 0.1
#define WEIGHT_REF 2
#define WEIGHT_TRANSIENT 100

...
void costCalculator::calcPathCost()
{
  ...
  for (int i = 0; i < m_path_cadidates_ptr_vec.size(); i++)
  {
    ...
    // std::cout << "m_calc_path_first_called : " << m_calc_path_first_called << std::endl;
  ...
  if (m_last_min_cost_idx != -1 && m_last_min_cost_idx != min_cost_frenet_path_idx)
  {
    std::cout
        << "min_cost_frenet_path_idx : " << min_cost_frenet_path_idx << std::endl;
    std::cout << "m_cost_collision_vec : " << m_cost_collision_vec[min_cost_frenet_path_idx] << std::endl;
    std::cout << "m_cost_curvature_vec : " << m_cost_curvature_vec[min_cost_frenet_path_idx] << std::endl;
    std::cout << "m_cost_origin_vec : " << m_cost_origin_vec[min_cost_frenet_path_idx] << std::endl;
    std::cout << "m_cost_ref_vec : " << m_cost_ref_vec[min_cost_frenet_path_idx] << std::endl;
    std::cout << "m_cost_transient_vec : " << m_cost_transient_vec[min_cost_frenet_path_idx] << std::endl;

...
if __name__ == "__main__":
    ...
    TRACK_NAME = 'CTRACK'
    TRANSITION_FILE = 'transitions.ctrack.yaml'
    ...
    center_line = os.path.join(waypoint_manager_path, 'maps',TRACK_NAME,'center_line.csv',)
    ...
    line_2 = os.path.join(waypoint_manager_path, 'maps',TRACK_NAME,'trackboundary_right.csv',)

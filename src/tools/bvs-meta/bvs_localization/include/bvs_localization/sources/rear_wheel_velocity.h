 ...
 **/
#ifndef BVS_LOCALIZATION_SOURCES_WHEEL_VELOCITY_H_
#define BVS_LOCALIZATION_SOURCES_WHEEL_VELOCITY_H_
 ...
 **/
class RearWheelVelocity : public estimate::EstimateSource {
public:
    static constexpr double kph2ms = 1.0/3.6;

    const estimate::EstimateSource::PubType pub_type 
        = estimate::EstimateSource::PubType::Twist;

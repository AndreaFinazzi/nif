 ...
 **/
#ifndef BVS_UTILS_GEODETIC_CONV_H_
#define BVS_UTILS_GEODETIC_CONV_H_
...
public:
    ...
    typedef std::shared_ptr<GeodeticConverter> SharedPtr;
    ...
    /**
     * @brief convert from week milliseconds to epoch time
     * @param weeks number of weeks since January 6, 1980
     * @param week_milliseconds milliseconds into the week
     * @return epoch time
     *
     * @note assumes we are after the second rollover (2019) and before the thirds (2038)
     **/
    double weekMSToEpoch(int weeks, int week_milliseconds);
...
#endif // BVS_UTILS_GEODETIC_CONV_H_

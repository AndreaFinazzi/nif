 ...
 **/
#ifndef BVS_UTILS_PATH_LOADING_H_
#define BVS_UTILS_PATH_LOADING_H_
...
public:
     ...
     *  after reading it in
     **/
    void loadPath(std::string csv_path, std::string frame_id = "", bool transform_to_ltp = true);
     ...
     **/
    nav_msgs::msg::Path
    wrapPathTo(geometry_msgs::msg::Pose pose, int pose_limit = -1);
...
#endif /* BVS_UTILS_PATH_LOADING_H_ */